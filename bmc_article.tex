...
% There is no doubt that the community of researchers that develops
% and/or uses cheminformatics tools in response to pandemics is quite
% large and engaged and so cheminformatics journals should reflect on
% this. Yet, the absolute majority of these papers as you said use
% out-of-the box tools, often in a very superficial manner, and produce
% hits that have little value even before testing.
...
% hypothesis generation. I’d propose that addressing the issues of
...
% more to the point than the issues you highlighted. It would be useful
...
% In brief, I suggest we contemplate a different template for this
% editorial, with subtitles that are highly specific to the issue at
% hand; and save the currently proposed content for another editorial on
% open science, data sharing, and open publications.

% Cheminformatics in action

% Covid moonshot probably the largest open source discovery project at
% present is the Covid Moonshot project to find inhibitors of the Main
% protease of Covid19. This involves about 300 participants with a
% core group of about 20, vast computational resources and synthesis
% and amazingly, a synchrotron producing scores of structures each
% week, combined with numerous ant-viral test facillities up to in
% vivo modes. So far, we have starting points (warheads) around 500nM.
% Please see 
% https://fragalysis.diamond.ac.uk/viewer/react/preview/target/Mpro

% https://www.nature.com/articles/s41557-020-0496-2

% https://postera.ai/covid
% JEDI
...
% - you can make information open, like PubChem did, you can make an
% open script to use it, like I did, you can offer to help colleagues
% with data analysis, like I did, and the uptake is small. why? People
% use what they are used to in a crisis, some of our methods are not yet
% ready to go. It's a useful lesson for open science. open alone is not
% everything.
